  ...
  return (
    <div className="container mx-auto">
      <div className="lg:h-[550px] flex lg:flex-row flex-col ">
        ...
        <div className="lg:w-1/2 h-full bg-amber-300 lg:px-20 px-6 py-8 lg:py-24">
          <h1 className="lg:text-[18px] text-sm font-semibold text-zinc-800">
            Special Nirvanta Hosting
          </h1>
          <div className="lg:text-5xl text-xl gap-1 font-bold py-3 text-zinc-800">
            <h1>High-Performance</h1>
            <h1>WordPress Hosting</h1>
          </div>
          <div className="lg:text-[18px] text-zinc-800 lg:pt-6 lg:pr-20 lg:pb-2 lg:leading-relaxed flex flex-col gap-1.5 text-justify">
            <p>
      ...
      <div className="lg:py-32 py-16">
        <div>
          ...
          <div className="lg:py-16 flex lg:flex-row flex-col text-center items-center justify-evenly lg:px-[100px]">
            <div>
              ...
              <div className="lg:text-2xl font-semibold lg:py-7 text-sm py-2">
                <h1 className="lg:px-20">Purchase Nirvanta on Themeforest</h1>
              </div>
            </div>
            <div className="py-8">
              <div className="lg:h-52 h-20 flex justify-center items-center">
              ...
              <div className="lg:text-2xl font-semibold lg:py-7 text-sm py-2">
                <h1 className="lg:px-20">Click To Sign Up For Hosting</h1>
              </div>
            </div>
            <div>
              <div className="lg:h-52 h-20 flex justify-center items-center">
        ...
        <div className="lg:px-[200px] py-14 flex flex-col-reverse lg:flex-row lg:items-center lg:h-[700px]">
        ...
        <div className="lg:px-[150px] flex lg:flex-row flex-col">
          <div className="lg:w-1/2 lg:h-[500px] flex justify-center">
            <img
              src={custom}
              alt="custom"
      ...
      <div className="lg:px-[120px] bg-sky-100 lg:py-28 px-4 py-10 flex lg:flex-row flex-col-reverse items-center">
